...
project(":sefariadiff").projectDir = file("generator/sefariadiff")
project(":dbversion").projectDir = file("generator/dbversion")
project(":externalbooks").projectDir = file("generator/externalbooks")
